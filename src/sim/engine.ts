...
import { COMMS_KINDS, IDLE_INTENT, type CommsKind, type DamageSite, type InboxMessage, type Intent, type OutboxMessage, type RobotController, type SensedAlly, type SensedBullet, type SensedHazard, type SensedRobot, type SenseEvent, type SensePad, type SensePadKind, type SenseState, type SenseTurret, type TrackedFoe } from './types';
...
export class Match {
    ...
    step(): void {
        ...
        this.stepTurrets();
        // 5d. Hazards: seed-scheduled asteroid strikes, pre-sudden-death only.
        this.stepHazards();
